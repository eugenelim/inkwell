...
Moved to **spec 15** (compose / reply). They share this executor's optimistic-apply + queue + replay machinery but the editor lifecycle, body templating, header parsing, and Outlook hand-off are substantial enough to live in their own spec. See `docs/specs/15-compose-reply/spec.md`.
