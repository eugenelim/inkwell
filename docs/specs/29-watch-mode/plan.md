...
## DoD checklist
Mirrors `docs/specs/29-watch-mode/spec.md` §9. Tick as work lands.
...
- [ ] **Doc sweep (`docs/CONVENTIONS.md` §12.6)**:
  - [ ] `docs/specs/29-watch-mode/spec.md` carries a
...
- Key design decisions captured in the spec:
  ...
  - **Privacy:** stdout is the user's terminal/pipe, like every
    ...
    `~/` complies).
- Result: `docs/specs/29-watch-mode/spec.md` ready for implementation.
