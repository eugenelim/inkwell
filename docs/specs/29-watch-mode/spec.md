...
- [ ] **Doc sweep (`docs/CONVENTIONS.md` §12.6)**:
  - [ ] `docs/specs/29-watch-mode/spec.md` carries the
        `**Shipped:** vX.Y.Z` line at the top of the metadata
        block once shipped.
  - [ ] `docs/specs/29-watch-mode/plan.md` exists and is updated each
...
- [ ] **Spec 17 review** (security testing + CASA evidence): watch
      ...
      `docs/specs/17-security-testing-and-casa-evidence/spec.md` §4,
...
- [ ] **Spec 03 consistency:** watch consumes `Notifications()`
      ...
      bug fixed in iter 10 of `docs/specs/03-sync-engine/plan.md`). Watch
