...
└── specs/35-body-regex-local-indexing/plan.md                  # tracking note (`docs/CONVENTIONS.md` §13)
```
...
| `docs/specs/35-body-regex-local-indexing/plan.md` | Tracking note (`docs/CONVENTIONS.md` §13) created at draft time; finalised at ship. |
