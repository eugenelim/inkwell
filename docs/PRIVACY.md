...
| --- | --- | --- | --- |
| OAuth access + refresh tokens | macOS Keychain (encrypted at rest by the OS) | Keychain ACL | Never written to filesystem in plaintext. `docs/CONVENTIONS.md` §7 rule 2. |
